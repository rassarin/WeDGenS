<?php
/**
 * applicaiton/modules/api/controllers/GetParamListController.php
 *
 * get-param-list コントローラ。
 *
 * @category    Api
 * @package     Controller
 * @subpackage  Action
 * @author      Mitsubishi Space Software Co.,Ltd.
 * @version     SVN: $Id: GetParamListController.php 28 2014-03-03 08:53:59Z nobu $
 * @since       File available since Release 1.0.0
 * @see         App_Controller_DefaultAction
*/

/**
 * Api_GetParamListController クラス
 *
 * @category    Api
 * @package     Controller
 * @subpackage  Action
 * @author      Mitsubishi Space Software Co.,Ltd.
*/
class Api_GetParamListController extends App_Controller_ApiAction
{
    // ---------------------------------------------------------------------- //
    ...
    public function xmlAction()
    {
        ...
        return $this->forward('index', 'get-param-list', 'api', $params);
    }
