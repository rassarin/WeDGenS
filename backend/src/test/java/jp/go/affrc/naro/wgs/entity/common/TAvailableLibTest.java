...
public class TAvailableLibTest extends S2TestCase {
    ...
    public void testFindById() throws Exception {
        jdbcManager.from(TAvailableLib.class).id("aaa").getSingleResult();
    }
    ...
    public void testLeftOuterJoin_TAvailableGeneratorList() throws Exception {
        jdbcManager.from(TAvailableLib.class).leftOuterJoin(TAvailableGeneratorList()).id("aaa").getSingleResult();
    }
}