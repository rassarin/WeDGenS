...
public class MFileTypeTest extends S2TestCase {
    ...
    public void testFindById() throws Exception {
        jdbcManager.from(MFileType.class).id("aaa").getSingleResult();
    }
    ...
    public void testLeftOuterJoin_MDataTypeList() throws Exception {
        jdbcManager.from(MFileType.class).leftOuterJoin(MDataTypeList()).id("aaa").getSingleResult();
    }
}